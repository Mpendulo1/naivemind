...
function FormFields() {
    ...
    const { model, getPrediction, isComputing, tempData, setTempData, addData } = useContext(ModelContext);
    ...
    return(
        ...
        </Formik>
        {
            ...
            <div className="flex justify-center items-center my-4">
                ...
                <span className="text-xl text-indigo-400">Computing...</span>
            </div>
            :
            tempData && 
            <div className="flex flex-col bg-indigo-400 rounded mt-3 py-1 px-2">
                <p className="text-yellow-400 font-sm">Prediction🎊</p>
                <p className="self-center text-xl text-white pb-2">{tempData.attributes.decision}</p>
            </div>
        }
        {
            !tempData ?
            ...
            <button onClick={() => setTempData(null)} className="uppercase bg-red-600 hover:bg-red-500 text-md text-white font-bold px-4 py-2 my-4 rounded-lg shadow-md" >discard</button>
